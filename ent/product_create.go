...
func (_c *ProductCreate) SetStockQuantity(v int) *ProductCreate {
	_c.mutation.SetStockQuantity(v)
	return _c
}

// SetNillableStockQuantity sets the "stock_quantity" field if the given value is not nil.
func (_c *ProductCreate) SetNillableStockQuantity(v *int) *ProductCreate {
	if v != nil {
...
func (_c *ProductCreate) AddOrderItemIDs(ids ...int) *ProductCreate {
	_c.mutation.AddOrderItemIDs(ids...)
	return _c
}

// AddOrderItems adds the "order_items" edges to the OrderItem entity.
func (_c *ProductCreate) AddOrderItems(v ...*OrderItem) *ProductCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProductCreate) defaults() {
	if _, ok := _c.mutation.StockQuantity(); !ok {
...
func (_c *ProductCreate) check() error {
	...
	if v, ok := _c.mutation.StockQuantity(); ok {
